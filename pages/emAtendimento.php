          ...
          <section class="content">
            <div class="box box-warning">
              <div class="box-header with-border">
                <h3 class="box-title">Em Atendimentos</h3>
              </div>              
              <div class="box-body" >
                <div class="form-group input-group">
                  <form method="GET" id="form_select" class="navbar-form navbar-left">
                    ...
                    <span class="input-group-btn">
                      <button type="submite" name="bnt_search" id="bnt_search" class="btn btn-flat btn-info"><i class="fa fa-search"></i>
                      </button>
                    </span>
                  </form>
                </div>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php  listarChamadosAtendimentos();   ?>    
                  </tbody>
                </table>
              </div><!-- /.box-body -->
            </div><!-- /.box -->
